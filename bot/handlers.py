...
async def cmd_start(message: Message) -> None:
    ...
    await message.answer(
        ...
        "📸 *Как должно выглядеть нормальное ДЗ:*\n"
        "• Хорошее освещение, без мыла и теней\n"
        "• Чёткий почерк (я не расшифровываю клинопись)\n"
        "• Одна задача = одно фото, не кидай мне целый разворот\n\n"
